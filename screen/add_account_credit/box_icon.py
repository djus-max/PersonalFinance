...
from general_box.box_icon import BoxForIconDetail, BoxIconCarousel, BoxForIcon
...
class BoxChoiceIconAccounnt(MDBoxLayout):
    """  ids = box_category
    ...
    def __init__(self, **kwargs):
        ...
        self._info = {
            'box_for_icon': BoxForChoiceIconAccounnt,
            'box_for_icon_detail': BoxForChoiceIconDetailAccounnt,
            'root_box': self,
        }
...
class BoxChoiceIconCarouselAccounnt(BoxIconCarousel):
...
class BoxForChoiceIconAccounnt(BoxForIcon):
...
class BoxForChoiceIconDetailAccounnt(BoxForIconDetail):
    ...
    def set_active_icon(self):
        ...
        self.info['root_box'].main_screen.data_for_query.update({
                                'icon_name': self.data.name,
                            })
